        ...
        <div class="row">
          <div class="col-lg-12">
            <span class="breadcrumb"
              ><a href="#">Home</a> / ${propertyData.title ? propertyData.title : "-"}</span
            >
            <h3>${propertyData.title ? propertyData.title : "-"}</h3>
          </div>
        </div>
      </div>
    `
        ...
        <div class="row">
          <div class="col-lg-8">
            <div class="main-image">
              <img src="${propertyData.image ? propertyData.image : "assets/images/properteez-placeholder.jpg"}" alt="Property Image" />
            </div>
            <div class="main-content">
              <div class="tag-container d-flex justify-content-between">
                <div>
                  <span class="tag type">${propertyData.type ? propertyData.type : "-"}</span>
                  <span class="tag price">${propertyData.price ? propertyData.priceFormatted() : "-"}</span>
                </div>
                <div>
                  <button
              ...
              <h4>${propertyData.title ? propertyData.title : "-"}</h4>
              ${propertyData.description ? propertyData.description : "No description added yet."}
            </div>
          </div>
          <div class="col-lg-4">
            <div class="info-table">
              <ul>
                <li>
                  ...
                  <h4>${propertyData.area ? `${propertyData.area}m<sup>2</sup>` : "-"} <br /><span>Total Space</span></h4>
                </li>
                <li>
                  <img
                    ...
                    alt=""
                  />
                  <h4>${propertyData.bedrooms ? propertyData.bedrooms : "-"}<br /><span>Bedrooms</span></h4>
                </li>
                <li>
                  <img src="assets/images/bath-svgrepo-com.svg" alt="" />
                  <h4>${propertyData.bathrooms ? propertyData.bathrooms : "-"}<br /><span>Bathrooms</span></h4>
                </li>
                <li>
                  <img src="assets/images/floor-plan-svgrepo-com.svg" alt="" />
                  <h4>${propertyData.floor ? propertyData.floorFormatted() : "-"}<br /><span>Floor</span></h4>
                </li>
              </ul>
            </div>
          </div>
...
function renderProperty() {
  ...
  var property = propertyStore.findProperty(urlParams.get('id'));
  var pageHeading = document.querySelector(".page-heading");
  var propertyDetails = document.querySelector(".single-property");

  if (property) {
    pageHeading.innerHTML = SinglePropertyHeadingTemplate(property);
    propertyDetails.innerHTML = SinglePropertyDetailsTemplate(property);
  } else {
    pageHeading.style.display = "none";
    propertyDetails.innerHTML = NotFoundTemplate();
  }
